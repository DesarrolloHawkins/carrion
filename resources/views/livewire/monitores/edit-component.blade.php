            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <form wire:submit.prevent="update">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-9">
                                <label class="col-sm-12 col-form-label" for="descripcion">Descripción</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="" id="" cols="30" rows="10" wire:model="descripcion"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" wire:model="nivel_estudios" class="form-control"
                                        name="nivel_estudios" id="nivel_estudios" placeholder="Bachiller...">
                                    @error('codigo_postal')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" wire:model="nombre_padre" class="form-control"
                                        name="nombre_padre" id="nombre_padre" placeholder="José...">
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" wire:model="nombre_madre" class="form-control"
                                        name="nombre_madre" id="nombre_madre" placeholder="María...">
                                    @error('nombre_madre')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button class="w-100 btn btn-danger mb-2" wire:click="destroy" id="alertaEliminar">Eliminar
                                Monitor</button>
                        </div>
                    </div>
                </div>
